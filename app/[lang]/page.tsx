    ...
    if (personalInfo)
        return (
            <main>
                ...
                >
                    <LandingSection lang={params.lang} personalInfo={personalInfo} />
                    <HighlightsSection lang={params.lang} highlights={highlights} />
                    <ExperienceSection lang={params.lang} experience={experience} />
                    <ProjectsSection lang={params.lang} projects={projects} />
                </div>
                <ContactMeSection lang={params.lang} personalInfo={personalInfo} />
